...
// TEMPERATURE CHART
// ======================
new (0, _autoDefault.default)(document.getElementById('temperatureChart'), {
    type: 'line',
    data: {
        labels,
        datasets: [
...
// HUMIDITY CHART
// ======================
new (0, _autoDefault.default)(document.getElementById('humidityChart'), {
    type: 'line',
    data: {
        labels,
        datasets: [
...
// PRESSURE CHART
// ======================
new (0, _autoDefault.default)(document.getElementById('pressureChart'), {
    type: 'line',
    data: {
        labels,
        datasets: [
